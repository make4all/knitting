                        ...
                        if next_bed == current_bed:
                            ...
                            if prior_loop in self.loop_id_to_knit_dir.keys():
                                ...
                                if (self.node_on_front_or_back[prior_loop] == 'f' and self.node_to_course_and_wale_and_bed[prior_loop][1] == self.courses_to_max_wale_on_front[prior_loop_course_id]) \
                                    or (self.node_on_front_or_back[prior_loop] == 'b' and self.node_to_course_and_wale_and_bed[prior_loop][1] == self.courses_to_max_wale_on_back[prior_loop_course_id]):
                                    dir = '+'
                                    self.loop_id_to_knit_dir[prior_loop] = dir
                                    dir = '+' if dir == '-' else '-'
                                    self.loop_id_to_knit_dir[next_loop] = dir
                                elif (self.node_on_front_or_back[prior_loop] == 'b' and self.node_to_course_and_wale_and_bed[prior_loop][1] == self.courses_to_min_wale_on_back[prior_loop_course_id]) \
