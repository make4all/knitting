...
def test_stst():
    ...
    knit_graph = compiler.compile(8, 6, object_type = 'sheet', pattern = sheet_pattern)
    # for tube
    ...
    hole_generator = Hole_Generator_on_Sheet(yarns_and_holes_to_add = {1:[19, 20], 7:[34, 35], 4: [42]}, knitgraph = knit_graph)
